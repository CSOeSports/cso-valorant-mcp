...
@mcp.tool()
async def get_account(name: str, tag: str, force_update: bool = False) -> dict[str, Any]:
...
@mcp.tool()
async def get_account_by_puuid(puuid: str, force_update: bool = False) -> dict[str, Any]:
